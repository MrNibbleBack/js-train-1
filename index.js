...
function checkDataType(value) {
  ...
  let answer = `Значення ${value} має тип даних ${valueType}`;
  return answer;
}
...
function getUserStatus(age) {
  ...
  switch (true) {
    case age < 18:
      userAgeGroup = "Неповнолітній";
      break;
    case age >= 18 && age < 65:
      userAgeGroup = "Дорослий";
      break;
    case age >= 65:
      userAgeGroup = "Пенсіонер";
      break;
    default:
